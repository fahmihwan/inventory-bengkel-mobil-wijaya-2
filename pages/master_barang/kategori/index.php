                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="index.php?kategori=delete&id=<?= $data['id']; ?>" onclick="confirmDelete(event)" class="btn btn-sm btn-danger" id="delete-alert">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header ">
                <p class="modal-title fw-bold">Form Master Data Kategori</p>
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" id="kategori" placeholder="Nama Kategori">
                    </div>
                    <div class="clearfix">
